...
export const SearchPage = () => {
  ...
  const heroes=getHeroByName(heroName) //Una vez obtenido el array, podemos usar el mismo <HeroCard> </HeroCard> para mostrarlos
      ...
      <div className="row">
        ...
        <div className="col-4">
          ...
          <form action="" onSubmit={onSubmitSearch}>
            <input className="form-control "type="text" name="buscador" id=""  onChange={onInputChange} placeholder='Search a hero' value={buscador}/>
        ...
        <div className="col-8">
          ...
          {/* Si la query está vacia, muestra el div. De lo contrario, si una vez se busca con la query no se encuentra info, muestra el div 
          {
